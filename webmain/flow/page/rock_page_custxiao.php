...
$(document).ready(function(){
	...
	var c = {
		...
		getacturl:function(act){
			return js.getajaxurl(act,'mode_custxiao|input','flow',{'modeid':modeid});
		},
		...
		daoru:function(){
			window.managelistcustxiao = a;
			addtabs({num:'daorucustxiao',url:'flow,input,daoru,modenum=custxiao',icons:'plus',name:'导入销售'});
		},
		initcolumns:function(bots){
			...
			if(nstr)nstr=','+nstr+',';
			if(nstr=='' && isflow>0){
				d.push({text:'销售人',dataIndex:'base_name',sortable:true});
				d.push({text:'销售人部门',dataIndex:'base_deptname',sortable:true});
			}
			for(i=0;i<len;i++){
				d1 = fieldsarr[i];
				bok= false;
	...
	var bootparams = {
		...
		params:{atype:atype},
		columns:[{text:"销售人",dataIndex:"base_name",sortable:true},{text:"销售人部门",dataIndex:"base_deptname",sortable:true},{text:"销售单号",dataIndex:"sericnum"},{text:"销售单号",dataIndex:"num"},{text:"销售日期",dataIndex:"applydt",sortable:true},{text:"关联合同",dataIndex:"custractid"},{text:"客户名称",dataIndex:"custname"},{text:"优惠价格",dataIndex:"discount"},{text:"销售金额",dataIndex:"money",sortable:true},{text:"说明",dataIndex:"explain"},{text:"出库状态",dataIndex:"state",sortable:true},{text:"收款状态",dataIndex:"shoukuzt"},{text:"状态",dataIndex:"statustext"},{
...
//[自定义区域end]
	...
	js.initbtn(c);
	var a = $('#viewcustxiao_{rand}').bootstable(bootparams);
	c.init();
