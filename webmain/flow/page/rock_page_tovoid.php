...
$(document).ready(function(){
	{params}
	var modenum = 'tovoid',modename='单据作废申请',isflow=1,modeid='52',atype = params.atype,pnum=params.pnum,modenames='';
	if(!atype)atype='';if(!pnum)pnum='';
	var fieldsarr = [{"name":"\u7533\u8bf7\u4eba","fields":"base_name"},{"name":"\u7533\u8bf7\u4eba\u90e8\u95e8","fields":"base_deptname"},{"name":"\u5355\u53f7","fields":"sericnum"},{"fields":"modeid","name":"\u6d41\u7a0b\u6a21\u5757","fieldstype":"select","ispx":"0","isalign":"0","islb":"0"},{"fields":"modename","name":"\u6d41\u7a0b\u6a21\u5757","fieldstype":"hidden","ispx":"0","isalign":"0","islb":"1"},{"fields":"tonum","name":"\u4f5c\u5e9f\u5355\u53f7","fieldstype":"select","ispx":"0","isalign":"0","islb":"1"},{"fields":"type","name":"\u4f5c\u5e9f\u7c7b\u578b","fieldstype":"select","ispx":"0","isalign":"0","islb":"1"},{"fields":"explain","name":"\u8bf4\u660e","fieldstype":"textarea","ispx":"0","isalign":"0","islb":"1"}],fieldsselarr= [];
	...
	var c = {
		...
		getacturl:function(act){
			return js.getajaxurl(act,'mode_tovoid|input','flow',{'modeid':modeid});
		},
		...
		daoru:function(){
			window.managelisttovoid = a;
			addtabs({num:'daorutovoid',url:'flow,input,daoru,modenum=tovoid',icons:'plus',name:'导入单据作废申请'});
		},
	...
	var bootparams = {
		fanye:true,modenum:modenum,modename:modename,statuschange:false,tablename:jm.base64decode('dG92b2lk'),
		url:c.storeurl(),storeafteraction:'storeaftershow',storebeforeaction:'storebeforeshow',
		params:{atype:atype},
		columns:[{text:"申请人",dataIndex:"base_name",sortable:true},{text:"申请人部门",dataIndex:"base_deptname",sortable:true},{text:"单号",dataIndex:"sericnum"},{text:"流程模块",dataIndex:"modename"},{text:"作废单号",dataIndex:"tonum"},{text:"作废类型",dataIndex:"type"},{text:"说明",dataIndex:"explain"},{text:"状态",dataIndex:"statustext"},{
...
//[自定义区域end]
	...
	js.initbtn(c);
	var a = $('#viewtovoid_{rand}').bootstable(bootparams);
	c.init();
